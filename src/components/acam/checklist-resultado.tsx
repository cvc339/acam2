...
const todasCompensacoes: { id: Compensacao; nome: string; lei: string }[] = [
  { id: "mineraria", nome: "Minerária", lei: "Lei 20.922/2013" },
  { id: "mata-atlantica", nome: "Mata Atlântica", lei: "Lei 11.428/2006" },
  { id: "app", nome: "APP", lei: "Decreto 47.749/2019" },
  { id: "snuc", nome: "SNUC", lei: "Lei 9.985/2000" },
  { id: "reserva-legal", nome: "Reserva Legal", lei: "Lei 12.651/2012" },
  { id: "reposicao-florestal", nome: "Reposição Florestal", lei: "Lei 20.308/2012" },
  { id: "ameacadas", nome: "Espécies Ameaçadas", lei: "DN COPAM 147/2010" },
  { id: "imunes", nome: "Espécies Imunes", lei: "Lei 12.651/2012" },
]
    ...
    <section>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {todasCompensacoes.map((c) => {
          ...
          return (
            <div key={c.id} className="acam-card acam-card-hover acam-card-compact cursor-pointer">
