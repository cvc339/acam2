...
export default function DestinacaoUCMaPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const res = await fetch("/api/consultas/dest-uc-ma", { method: "POST", body: formData })
  ...
  if (resultado) {
    ...
    return (
      <div className="acam-container">
        ...
        >
          <strong>Mata Atlântica — Destinação em UC.</strong> {p.recomendacao}
        </AlertResult>
        ...
        <CTAConsultoria contexto="mata-atlantica" />
      </div>
    )
  }
  ...
  return (
    <div>
        ...
        <div className="acam-service-header-content">
          <div className="acam-service-header-info">
            ...
            <div className="acam-service-header-text">
              <h1>Destinação em UC — Mata Atlântica</h1>
              <p>Compensação Mata Atlântica — Destinação em Unidade de Conservação</p>
            </div>
          </div>
      ...
      <div className="acam-container">
        ...
        {!loading && <AlertResult>
          <strong>O que será analisado:</strong> Ambas as áreas serão verificadas quanto ao bioma Mata Atlântica, bacia hidrográfica e cobertura vegetal (MapBiomas + Sentinel-2 NDVI). A matrícula será processada por IA. O sistema avaliará os 6 critérios do Decreto 47.749/2019 para destinação em UC.
        </AlertResult>}
